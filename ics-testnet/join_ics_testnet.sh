...
CHAIN_NAME=stride-ics-testnet-two-1
PERSISTENT_PEER_ID="d747545dbab1eb86caff7ec64fca3b7f2ace07fd@stride-direct.testnet-2.stridenet.co:26656"
SEED_ID=""
...
# while true; do
#     fetched_state="$(curl -s https://stride-validator.$TESTNET.stridenet.co/commit | jq "{height: .result.signed_header.header.height, hash: .result.signed_header.commit.block_id.hash}")"
...
statesync_rpc="stride-validator.$TESTNET.stridenet.co:26657,stride-validator.$TESTNET.stridenet.co:26657"
...
launch_file=$INSTALL_FOLDER/launch_stride_ics_testnet.sh
rm -f $launch_file
